...
def random_spilt(root_dir, train_radio):
    # Each class of samples is randomly divided into training and testing proportionally
    # Returns a list of paths for training and testing samples
    train_items = []
    test_items = []
    for (root, dirs, files) in os.walk(root_dir):
        dirs.sort()
        # Set the training and testing ratios and assign indexes

...
parser.add_argument('--num_workers', default=0, type=int)  # used
parser.add_argument('--optim', default='SGDM', type=str)  # used
parser.add_argument('--grid_search', default='./summary.csv', type=str)  # used
parser.add_argument('--act', default='mns_rec', type=str)  # used
parser.add_argument('--alpha', default=3.0, type=float)  # used
parser.add_argument('--decay', default=None, type=float)  # used
parser.add_argument('--thresh', default=0.5, type=float)  # used
parser.add_argument('--p', default=0.0, type=float)  # used
parser.add_argument('--gamma', default=1.0, type=float)  # used
...
parser.add_argument('--T', default=2, type=int, help='num of time steps')  # used

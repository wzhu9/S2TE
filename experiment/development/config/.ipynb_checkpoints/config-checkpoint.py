...
parser.add_argument('--act', default='mns_rec', type=str)  # used # check
...
parser.add_argument('--p', default=0.0, type=float)  # used # check
parser.add_argument('--gamma', default=1.0, type=float)  # used # check

...
def main():
    ...
    for epoch in tqdm(range(start_epoch, start_epoch + args.num_epoch)):
        ...
        # Pruning and regeneration of convolutional layer weights till epoch_stable
        ...
        weights_mask, weights_mask_core, fixed_stop_epoch = rewire_mask(weights, zeta, rf, epoch, stop_epoch, sparse_para_num_list[len(io_params)-1], epoch_growth, epoch_stable)
        stop_epoch = fixed_stop_epoch

...
parser.add_argument('--num_epoch', default=150, type=int)  # used
...
parser.add_argument('--alpha', default=3.0, type=float)  # used # check
parser.add_argument('--use_gate', default=False, action='store_true')  # used
parser.add_argument('--granularity', default='layer',  type=str)  # used
parser.add_argument('--decay', default=None, type=float)  # used
parser.add_argument('--thresh', default=0.5, type=float)  # used
parser.add_argument('--p', default=None, type=float)  # used
parser.add_argument('--gamma', default=None, type=float)  # used
...
parser.add_argument('--T', default=10, type=int, help='num of time steps')  # used
...
parser.add_argument('--means', default=1.0, type=float, metavar='N',
                    help='make all the potential increment around the means (default: 1.0)')  # used
parser.add_argument('--lamb', default=1e-3, type=float, metavar='N',
                    help='adjust the norm factor to avoid outlier (default: 0.0)')  # used
parser.add_argument('--sparsity', default=0.7, type=float)  # used
parser.add_argument('--train_width', action='store_true')  # used
parser.add_argument('--phi_a', default=0.666, type=float)  # used
parser.add_argument('--phi_c', default=0.333, type=float)  # used
parser.add_argument('--zeta', default=0.3, type=float)  # used
